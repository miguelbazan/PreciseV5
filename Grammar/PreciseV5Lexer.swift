...
open class PreciseV5Lexer: Lexer {
	...
	public
	static let PROGRAM=1, VAR=2, FUNCTION=3, END=4, MAIN=5, IF=6, ELSE=7, PRINT=8, 
            READ=9, WHILE=10, INT=11, FLOAT=12, CHAR=13, BOOL=14, VOID=15, 
            COLON=16, SCOLON=17, COMA=18, DOT=19, RPAREN=20, LPAREN=21, 
	...
	static let ruleNames: [String] = [
		...
		"UPPERCASE", "APOS", "PROGRAM", "VAR", "FUNCTION", "END", "MAIN", "IF", 
		"ELSE", "PRINT", "READ", "WHILE", "INT", "FLOAT", "CHAR", "BOOL", "VOID", 
		...
		"FALSE", "CTEINT", "CTEFLOAT", "CTEBOOL", "CTECHAR", "ID", "BSPACE"
	]
